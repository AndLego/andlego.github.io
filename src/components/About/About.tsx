    ...
    return (
        <section className={style.about}>
            ...
            <article>
                ...
                <p>Over the past year, I have taken courses on platforms such as Platzi, Udemy, and Coursera to expand my knowledge of web development. </p>
                <p>I have also actively practiced coding by participating in coding challenges on LeetCode, CodeWars, and Advent of Code.</p>

                <p>As a web developer, I am constantly learning and seeking out new challenges. I am driven by a passion for problem-solving and a desire to create high-quality, user-friendly websites that help businesses succeed. </p>
